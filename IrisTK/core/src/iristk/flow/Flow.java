...
public abstract class Flow {
	...
	public State getState(String name) throws Exception {
		return (State) Class.forName(getClass().getName() + "$" + name).getDeclaredConstructor(getClass()).newInstance(this);
	}
	...
	*/
	...
	protected String randstr(String... strings) {
		return randstr(Arrays.asList(strings));
	}
	
	protected String randstr(List<String> strings) {
