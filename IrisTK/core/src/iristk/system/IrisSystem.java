...
public class IrisSystem implements EventListener {
	...
	static {
		//EventMarshaller.registerMarshaller(new TranscriptionMarshaller());
		try {
	...
	public IrisSystem(String name, File packageDir) throws Exception {
		...
		System.out.println("Initializing system " + systemName);
		startAsync();
	}

	public IrisSystem(String name, Class<?> packageClass) throws Exception {
		this(name, IrisUtils.getPackagePath(packageClass));
	}
	...
	public void connectToBroker(String ticket) throws IOException {
		BrokerClient brokerClient = new BrokerClient(ticket, systemName, brokerHost, brokerPort, this);
