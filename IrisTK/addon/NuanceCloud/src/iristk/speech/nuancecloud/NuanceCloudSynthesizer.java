...
public class NuanceCloudSynthesizer extends Synthesizer {
	...
	public NuanceCloudSynthesizer() throws Exception {
		...
		properties.load(new FileReader(IrisUtils.getPackagePath(NuanceCloudRecognizer.class, "license.properties")));
	...
	private static VoiceList voices = new VoiceList();
	static {
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Samantha", Gender.FEMALE, Language.ENGLISH_US));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Tom", Gender.MALE, Language.ENGLISH_US));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Allison", Gender.FEMALE, Language.ENGLISH_US));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Ava", Gender.FEMALE, Language.ENGLISH_US));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Susan", Gender.FEMALE, Language.ENGLISH_US));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Zoe", Gender.FEMALE, Language.ENGLISH_US));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Alva", Gender.FEMALE, Language.SWEDISH));
		voices.add(new Voice(NuanceCloudSynthesizer.class, "Oskar", Gender.MALE, Language.SWEDISH));
	}
