...
public class BaseRecognizer extends Thread {
	...
	* Recognizer parameters
	...
	public BaseRecognizer() throws NuanceException {
		File configFile = IrisUtils.getPackagePath(BaseRecognizer.class, "config.xml");
		File tempConfigDir = IrisUtils.getTempDir(IrisUtils.getPackageName(BaseRecognizer.class));
